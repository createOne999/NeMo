...
def load_model_with_modelopt_spec(restore_path, trainer) -> llm.GPTModel:
...
def save_pruned_model(model, unwrapped_model, trainer, save_path):
    ...
    dist_checkpointing.save(unwrapped_model.sharded_state_dict(), weight_path)
...
def main(args):
    ...
    save_pruned_model(model, unwrapped_model, trainer, args.save_path)
